...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Models\Personas\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/kayo/Documentos/estudos/projetos/NerumXP/public/storage' => 'string',
...
'database.connections.mariadb.prefix','database.connections.mariadb.prefix_indexes','database.connections.mariadb.strict','database.connections.mariadb.engine','database.connections.pgsql.driver',
...
'filesystems.disks.s3.report','filesystems.links./home/kayo/Documentos/estudos/projetos/NerumXP/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'debugbar.queries.explain','home',
'registro.index','registro.create','registro.show','registro.store','registro.edit',
'registro.put','registro.destroy','meta.index','meta.create','meta.show',
'meta.edit','meta.store','meta.put','meta.destroy','relatorio.index',
'register.create','register.store','login.create',
'storage.local',);
        registerArgumentsSet('views', 
'about','authHome','components.helper.categoria','components.helper.error','components.helper.nothing',
'components.helper.notice','components.layout','components.meta.form','components.meta.formGenerica','components.meta.list',
'components.nav.accountPanel','components.nav.authBar','components.nav.footer','components.nav.guestBar','components.nav.nav-link',
'components.nav.navbar','components.registro.card','components.registro.filterPanel','components.registro.form','conta.login.create',
'conta.registration.create','guestHome','meta.create','meta.edit','meta.index',
'meta.show','pagination::bootstrap-5','pagination::default','pagination::simple-bootstrap-5','registro.create',
'registro.edit','registro.index','registro.show','relatorio.index','vendor.pagination.bootstrap-5',
'vendor.pagination.default','vendor.pagination.simple-bootstrap-5','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.doesnt_contain',
'validation.exclude','validation.exclude_if','validation.exclude_unless','validation.exclude_without','validation.mac',
'validation.custom.password.min','validation.custom.password.mixed_case','validation.custom.password.numbers','validation.custom.password.symbols','validation.custom.password.uncompromised',
'validation.custom.nome.min','validation.custom.nome.max',);
...
'DB_PASSWORD','DB_LOCALE_TIME_NAMES','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
