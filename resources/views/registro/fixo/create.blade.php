            ...
            <div class="card shadow-sm transition-all-300 hover-shadow-lg hover-translate-y-1">
                <div class="card-header bg-success text-white">
                    <h2 class="card-title mb-0">
                        ...
                        Cadastro de Registros Fixos
                    </h2>
                </div>
                <div class="card-body">
                    <form id="registroForm" method="POST" action="{{ route("registroFixo.store") }}">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nomeRegistro" name="nm_registroFixo"
                                            placeholder="Ex: Salário, Aluguel, Conta de Luz..." required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="descricao" name="descricao" rows="3"
                                                placeholder="Descrição detalhada do registro..."></textarea>
                                </div>
                            </div>
