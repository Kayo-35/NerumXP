            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label text-secondary fw-bold">Nível de Importância</label>
                            <div class="d-flex align-items-center">
                        ...
                        <div class="col-12">
                            <label class="form-label text-secondary fw-bold">Responsável</label>
                            <div class="d-flex align-items-center">
                        ...
                        <div class="col-12">
                            <label class="form-label text-secondary fw-bold">Localização</label>
                            <div class="d-flex align-items-center">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @else
                                    <x-helper.notice titulo="Não definida" desc="Nenhuma forma de pagamento definida"/>
                                @endisset
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label text-secondary fw-bold">Método(s)</label>
                            <div class="d-flex align-items-center">
                                @if($metodos->isNotEmpty())
                                    <div class="d-flex flex-column">
                                    @foreach($metodos as $metodo)
                                            <div class="bg-dark bg-opacity-10 p-2 rounded rounded-2 m-1">
                                                <i class="bi bi-currency-exchange text-secondary">
                                                    <span class="text-dark">{{ $metodo->nm_metodo }}</span>
                                                </i>
                                            </div>
                                    @endforeach
                                    </div>
                                @else
                                    <x-helper.notice titulo="Não definidos" desc="Nenhum método de pagamento definido"/>
                                @endif
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                @isset($registro->ds_descricao)
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-4">
                                <div class="bg-light p-3 text-center fs-6 rounded">
                                    <small class="text-secondary fw-bold d-block">Quantidade de palavras</small>
                                    <span class="text-dark">
                ...
                @else
                    <x-helper.notice titulo="Descrição Indefinida" desc="Nenhuma descrição para o registro fora definida"/>
                @endisset
            </div>
        </div>
    </div>
                        ...
                        <div class="row g-3">
                            @isset($registro->cd_tipo_juro)
                                <div class="col-md-6 m-1">
                                    <label class="form-label text-secondary fw-bold">Tipo de Juros</label>
                                    <div class="d-flex align-items-center">
                            ...
                            @isset($registro->pc_taxa_juros)
                                <div class="col-md-6">
                                    <label class="form-label text-secondary fw-bold">Taxa de Juros</label>
                                    <div class="d-flex align-items-center">
                                        <div class="bg-dark bg-opacity-10 p-2 rounded-circle me-2">
                            ...
                            @isset($registro->qt_meses_incidencia)
                                <div class="col-md-6">
                                    <label class="form-label text-secondary fw-bold">Período de Capitalização</label>
                                    <div class="d-flex align-items-center">
                                        <div class="bg-secondary bg-opacity-10 p-2 rounded-circle me-2">
                            ...
                            @isset($registro->dt_vencimento)
                                <div class="col-md-6">
                                    <label class="form-label text-secondary fw-bold">Data de Vencimento</label>
                                    <div class="d-flex align-items-center">
                                        <div class="bg-success bg-opacity-10 p-2 rounded-circle me-2">
                            ...
                            <div class="mt-3 p-3 bg-success bg-opacity-10 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <small class="text-success fw-bold">Registro Flutuante Ativo</small>
                                </div>
                                <small class="text-secondary d-block mt-1">
                                    Este registro possui juros flutuantes que serão aplicados conforme os parâmetros definidos acima.
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm bg-light">
                    ...
                    <div class="card-body">
                        <div class="text-center py-3">
                            <i class="bi bi-lock text-secondary fs-1 mb-2"></i>
                            <h6 class="text-secondary mb-1">Registro Fixo - Não se aplica</h6>
                            <small class="text-secondary">Este registro possui valor fixo e não está sujeito a variações de juros.</small>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="timeline">
                            <div class="d-flex mb-3">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 text-dark">Transação concluida</h6>
                                    <small class="text-secondary">15/06/2024 às 14:35 - PIX recebido com sucesso</small>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center row justify-content-center">
                    <div class="col-6">
                        <a class="btn btn-outline-success me-2" href="{{ route('registro.edit',[$registro]) }}">
