...
CREATE TABLE `historico` (
  ...
  `cd_origem_fixo` BIGINT UNSIGNED NOT NULL,
  `cd_origem_flutuante` BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE `metas_reg_fixo` (
  `cd_meta` BIGINT UNSIGNED NOT NULL,
  `cd_registro_fixo` BIGINT UNSIGNED NOT NULL,
  `created_at` TIMESTAMP NULL DEFAULT NULL ,
  `updated_at` TIMESTAMP NULL DEFAULT NULL ,
   PRIMARY KEY (`cd_meta`, `cd_registro_fixo`)
)
ENGINE = InnoDB;
CREATE TABLE `metas_reg_flut` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT NULL ,
  `updated_at` TIMESTAMP NULL DEFAULT NULL ,
   PRIMARY KEY (`cd_registro_flutuante`, `cd_meta`)
)
ENGINE = InnoDB;
...
ALTER TABLE `metas_reg_fixo` ADD CONSTRAINT `metas_reg_fixo_cd_meta_foreign` FOREIGN KEY (`cd_meta`) REFERENCES `metas` (`cd_metas`) ON DELETE CASCADE ON UPDATE RESTRICT;
ALTER TABLE `metas_reg_flut` ADD CONSTRAINT `metas_reg_flut_cd_meta_foreign` FOREIGN KEY (`cd_meta`) REFERENCES `metas` (`cd_metas`) ON DELETE CASCADE ON UPDATE RESTRICT;
